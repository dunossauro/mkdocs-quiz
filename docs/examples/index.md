...
This page demonstrates all the different types of quizzes and options available in mkdocs-quiz. Each example shows a working quiz followed by the markdown code used to create it.
